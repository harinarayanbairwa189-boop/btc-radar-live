...
export class Backend implements backendInterface {
    ...
    async fetchAndUpdatePrice(): Promise<FetchResult> {
        if (this.processError) {
            try {
                const result = await this.actor.fetchAndUpdatePrice();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getLatestPrice(): Promise<PriceSnapshot> {
        if (this.processError) {
            try {
                const result = await this.actor.getLatestPrice();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getOHLCHistory(): Promise<Array<Candle>> {
        if (this.processError) {
            try {
                const result = await this.actor.getOHLCHistory();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
